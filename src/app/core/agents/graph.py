"""LangGraph orchestration for the multi-agent QA flow with query planning."""
...
def create_qa_graph() -> Any:
    """Create and compile the multi-agent QA graph.
...
def run_qa_flow(question: str) -> Dict[str, Any]:
    ...
    2. Executes the multi-agent flow (Planning -> Retrieval -> Summarization -> Verification)
    ...
    Returns:
        ...
        - `sub_questions`: List of sub-questions from the plan
